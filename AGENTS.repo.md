...
- “How to run” (authoritative): `docs/runbooks/dev.md`
- “How to test” (authoritative): `docs/runbooks/test.md`
- “How to release/deploy” (if applicable): `docs/runbooks/release.md`
- Repo map / key directories: `docs/repo_map.md`
- Known pitfalls: `docs/gotchas.md`
...
2) Read the index: `docs/README.md`
...
If you learn something that will save future time, update `docs/`:
...
Put repo-specific, evolving knowledge in `docs/`.
